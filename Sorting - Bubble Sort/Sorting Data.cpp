...
void ngesortdata() {
	...
	puts("\n Pilih Menu Pengurutan Data");
    puts("  1.  Urutkan Menurut NPM (Ascending)");
    puts("  2.  Urutkan Menurut NPM (Descending)");
    puts("  3.  Urutkan Menurut Nama (Ascending)");
    puts("  4.  Urutkan Menurut Nama (Descending)");
    switch(getch()){
	        case '1' : npm_asc(maks);
	        printf("\nData Telah Diurutkan!\n\n");
	        break;
	        case '2' : npm_desc(maks);
	        printf("\nData Telah Diurutkan!\n\n");
	        break;
	        case '3' : nama_asc(maks);
	        printf("\nData telah Diurutkan!\n\n");
	        break;
	        case '4' : nama_desc(maks);
	        printf("\nData Telah Diurutkan!\n\n");
	        break;
	    }
}
